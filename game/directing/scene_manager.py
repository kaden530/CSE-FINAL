...
from game.scripting.collide_racket_1_action import CollideRacket1Action
from game.scripting.collide_racket_2_action import CollideRacket2Action
from game.scripting.control_racket_1_action import ControlRacket1Action
from game.scripting.control_racket_2_action import ControlRacket2Action
...
from game.scripting.draw_racket_1_action import DrawRacket1Action
from game.scripting.draw_racket_2_action import DrawRacket2Action
from game.scripting.end_drawing_action import EndDrawingAction
from game.scripting.initialize_devices_action import InitializeDevicesAction
from game.scripting.load_assets_action import LoadAssetsAction
from game.scripting.move_ball_action import MoveBallAction
from game.scripting.move_racket_1_action import MoveRacket1Action
from game.scripting.move_racket_2_action import MoveRacket2Action
...
class SceneManager:
    ...
    COLLIDE_RACKET_1_ACTION = CollideRacket1Action(PHYSICS_SERVICE, AUDIO_SERVICE, RACKET_GROUP_1)
    COLLIDE_RACKET_2_ACTION = CollideRacket2Action(PHYSICS_SERVICE, AUDIO_SERVICE, RACKET_GROUP_2)
    CONTROL_RACKET_1_ACTION = ControlRacket1Action(KEYBOARD_SERVICE, RACKET_GROUP_1)
    CONTROL_RACKET_2_ACTION = ControlRacket2Action(KEYBOARD_SERVICE, RACKET_GROUP_2)
    DRAW_BALL_ACTION = DrawBallAction(VIDEO_SERVICE)
    # DRAW_BRICKS_ACTION = DrawBricksAction(VIDEO_SERVICE)
    DRAW_DIALOG_ACTION = DrawDialogAction(VIDEO_SERVICE)
    DRAW_HUD_ACTION = DrawHudAction(VIDEO_SERVICE)
    DRAW_RACKET_1_ACTION= DrawRacket1Action(VIDEO_SERVICE, RACKET_GROUP_1)
    DRAW_RACKET_2_ACTION= DrawRacket2Action(VIDEO_SERVICE, RACKET_GROUP_2)
    END_DRAWING_ACTION = EndDrawingAction(VIDEO_SERVICE)
    INITIALIZE_DEVICES_ACTION = InitializeDevicesAction(AUDIO_SERVICE, VIDEO_SERVICE)
    LOAD_ASSETS_ACTION = LoadAssetsAction(AUDIO_SERVICE, VIDEO_SERVICE)
    MOVE_BALL_ACTION = MoveBallAction()
    MOVE_RACKET_1_ACTION = MoveRacket1Action(RACKET_GROUP_1)
    MOVE_RACKET_2_ACTION = MoveRacket2Action(RACKET_GROUP_2)
    ...
    def _prepare_in_play(self, cast, script):
        ...
        script.clear_actions(INPUT)
        script.add_action(INPUT, self.CONTROL_RACKET_1_ACTION)
        script.add_action(INPUT, self.CONTROL_RACKET_2_ACTION)
        self._add_update_script(script)
        self._add_output_script(script)
    ...
    def _add_racket_2(self, cast):
        ...
        x = SCREEN_WIDTH - 50 - RACKET_WIDTH / 2
        y = CENTER_Y - RACKET_HEIGHT / 2
        position = Point(x, y)
        size = Point(RACKET_WIDTH, RACKET_HEIGHT)
        velocity = Point(0, 0)
        body = Body(position, size, velocity)
        animation = Animation(RACKET_IMAGES_2, RACKET_RATE)
        racket = Racket(body, animation)
    ...
    def _add_output_script(self, script):
        ...
        script.add_action(OUTPUT, self.DRAW_RACKET_1_ACTION)
        script.add_action(OUTPUT, self.DRAW_RACKET_2_ACTION)
    ...
    def _add_update_script(self, script):
        ...
        script.add_action(UPDATE, self.MOVE_RACKET_1_ACTION)
        script.add_action(UPDATE, self.MOVE_RACKET_2_ACTION)
        script.add_action(UPDATE, self.COLLIDE_BORDERS_ACTION)
        # script.add_action(UPDATE, self.COLLIDE_BRICKS_ACTION)
        script.add_action(UPDATE, self.COLLIDE_RACKET_1_ACTION)
        script.add_action(UPDATE, self.COLLIDE_RACKET_2_ACTION)
        script.add_action(UPDATE, self.MOVE_RACKET_1_ACTION)
        script.add_action(UPDATE, self.MOVE_RACKET_2_ACTION)
